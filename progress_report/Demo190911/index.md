...
| epochs | 100 | <span style="color: red; ">10</span> |  
| patience | 0 | 0 |  
| Best_epoch | - | - |  
| End_epoch | 100 | 10 |  
| all_loss      | - | <img src="libritts_asrtts_offline/sample_rev2_train_pytorch_tts_train_pytorch_transformer.fine-tuning.rev1/result/all_loss.png" width="320px">        |  
| loss          | - | <img src="libritts_asrtts_offline/sample_rev2_train_pytorch_tts_train_pytorch_transformer.fine-tuning.rev1/result/loss.png" width="320px">            |  
| l1_loss       | - | <img src="libritts_asrtts_offline/sample_rev2_train_pytorch_tts_train_pytorch_transformer.fine-tuning.rev1/result/l1_loss.png" width="320px">         |  
| l2_loss       | - | <img src="libritts_asrtts_offline/sample_rev2_train_pytorch_tts_train_pytorch_transformer.fine-tuning.rev1/result/l2_loss.png" width="320px">         |  
| bce_loss      | - | <img src="libritts_asrtts_offline/sample_rev2_train_pytorch_tts_train_pytorch_transformer.fine-tuning.rev1/result/bce_loss.png" width="320px">        |  
| decoder_alpha | - | <img src="libritts_asrtts_offline/sample_rev2_train_pytorch_tts_train_pytorch_transformer.fine-tuning.rev1/result/decoder_alpha.png" width="320px">   |  
| encoder_alpha | - | <img src="libritts_asrtts_offline/sample_rev2_train_pytorch_tts_train_pytorch_transformer.fine-tuning.rev1/result/encoder_alpha.png" width="320px">   |  
